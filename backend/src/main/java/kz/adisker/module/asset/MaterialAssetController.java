...
@Tag(name = "Material Assets (МТБ)")
@RestController
@RequestMapping("/assets")
@RequiredArgsConstructor
public class MaterialAssetController {

    private final MaterialAssetService service;

    @GetMapping
    public ApiResponse<PageResponse<MaterialAssetDto>> list(
    ...
    @GetMapping("/{id}")
    public ApiResponse<MaterialAssetDto> getById(
    ...
    public ApiResponse<MaterialAssetDto> create(
            @Valid @RequestBody MaterialAssetRequest req,
            @AuthenticationPrincipal UserPrincipal principal) {
        return ApiResponse.ok("Asset created", service.create(principal.getOrganizationId(), req));
    }

    @PutMapping("/{id}")
    public ApiResponse<MaterialAssetDto> update(
            @PathVariable UUID id,
            @Valid @RequestBody MaterialAssetRequest req,
            @AuthenticationPrincipal UserPrincipal principal) {
